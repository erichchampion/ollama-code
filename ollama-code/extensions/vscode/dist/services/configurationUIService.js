...
exports.ConfigurationUIService = void 0;
const vscode = __importStar(require("vscode"));
const analysisConstants_1 = require("../config/analysisConstants");
class ConfigurationUIService {
    constructor(context, workspaceAnalyzer, notificationService) {
    ...
    async showConfigurationUI() {
        ...
        this.webviewPanel = vscode.window.createWebviewPanel('ollama-code-config', 'Ollama Code Configuration', vscode.ViewColumn.One, {
            enableScripts: true,
        ...
        return [
            {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        type: 'number',
                        default: analysisConstants_1.TIMEOUT_CONSTANTS.AI_ANALYSIS_TIMEOUT,
                        validation: (value) => {
     ...
     */
    getLanguageSpecificProfile(language) {
    ...
    async getConfigurationRecommendations() {
        ...
        if (workspaceContext.projectType === 'large') {
            ...
            const analysisDepth = config.get('ollama-code.analysisDepth', 'moderate');
     ...
     */
    async handleUpdateSetting(key, value) {
        const config = vscode.workspace.getConfiguration();
        await config.update(key, value, vscode.ConfigurationTarget.Workspace);
        this.webviewPanel?.webview.postMessage({
     ...
     */
    async handleValidateConfiguration() {
...
exports.ConfigurationUIService = ConfigurationUIService;
//# sourceMappingURL=configurationUIService.js.map
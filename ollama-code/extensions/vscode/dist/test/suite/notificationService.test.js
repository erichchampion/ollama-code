...
suite('NotificationService Tests', () => {
    ...
    test('should show AI insight notification', async () => {
        await notificationService.showAIInsight('Code Quality', 'This function could be optimized for better performance', 'suggestion');
    ...
    test('should show code suggestion notification', async () => {
        ...
        await notificationService.showCodeSuggestion('Use const instead of let', 'const value = 42;', applyAction);
    ...
    test('should show configuration recommendation', async () => {
        ...
        await notificationService.showConfigRecommendation(setting, currentValue, recommendedValue, reason);
    ...
    test('should handle multiple concurrent notifications', async () => {
        ...
        const promises = notifications.map(notification => notificationService.showNotification(notification));
    ...
    test('should dispose resources properly', () => {
        const testService = new notificationService_1.NotificationService();
    ...
    test('should handle progress cancellation', async () => {
        ...
        const task = async (progress, token) => {

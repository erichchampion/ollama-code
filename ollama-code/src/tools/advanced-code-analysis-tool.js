...
exports.AdvancedCodeAnalysisTool = void 0;
const types_js_1 = require("./types.js");
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const performance_js_1 = require("../config/performance.js");
const logger_js_1 = require("../utils/logger.js");
const architectural_analyzer_js_1 = require("../ai/architectural-analyzer.js");
const refactoring_engine_js_1 = require("../ai/refactoring-engine.js");
const test_generator_js_1 = require("../ai/test-generator.js");
const complexity_calculator_js_1 = require("../utils/complexity-calculator.js");
class AdvancedCodeAnalysisTool extends types_js_1.BaseTool {
    constructor() {
        super(...arguments);
        ...
        this.refactoringEngine = new refactoring_engine_js_1.RefactoringEngine();
    ...
    calculateFileCyclomaticComplexity(content) {
        ...
        return (0, complexity_calculator_js_1.calculateCyclomaticComplexity)(content, { thresholds: complexityThresholds }).cyclomaticComplexity;
    }
    ...
    scanFileForVulnerabilities(filePath) {
        ...
        try {
            ...
            logger_js_1.logger.warn(`Error scanning file ${filePath} for vulnerabilities:`, error);
            return [];
        }
    }
    ...
    async suggestRefactoring(target, context, options) {
        ...
        try {
            ...
            logger_js_1.logger.info('Starting enhanced refactoring analysis', { fileCount: fileContents.length });
    ...
    async analyzeArchitecture(target, context, options) {
        ...
        try {
            ...
            logger_js_1.logger.info('Starting enhanced architectural analysis', { fileCount: fileContents.length });
    ...
    calculateArchitecturalMetrics(files) {
        ...
        files.forEach(file => {
            try {
                ...
                logger_js_1.logger.warn(`Error analyzing file ${file}:`, error);
            }
        });
        return {
    ...
    async generateTests(target, context, options) {
        ...
        try {
            ...
            logger_js_1.logger.info('Starting enhanced test generation', { fileCount: fileContents.length });
...
exports.AdvancedCodeAnalysisTool = AdvancedCodeAnalysisTool;

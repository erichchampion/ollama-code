...
exports.getDefaultExcludePatterns = getDefaultExcludePatterns;
exports.globToRegex = globToRegex;
exports.globPatternsToRegexes = globPatternsToRegexes;
exports.isPathExcluded = isPathExcluded;
exports.getHighPriorityPatterns = getHighPriorityPatterns;
exports.getIncludePatterns = getIncludePatterns;
exports.shouldIncludeFile = shouldIncludeFile;
exports.getCompactExcludePatterns = getCompactExcludePatterns;
...
function getDefaultExcludePatterns() {
    const config = (0, performance_js_1.getPerformanceConfig)();
 ...
 */
function globPatternsToRegexes(patterns) {
 ...
 */
function getHighPriorityPatterns() {
    const config = (0, performance_js_1.getPerformanceConfig)();
 ...
 */
function isPathIncluded(path, patterns) {
 ...
 */
function getCompactExcludePatterns() {

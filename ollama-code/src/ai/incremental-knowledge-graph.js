...
exports.IncrementalKnowledgeGraph = void 0;
const code_knowledge_graph_js_1 = require("./code-knowledge-graph.js");
 ...
 */
class IncrementalKnowledgeGraph extends code_knowledge_graph_js_1.CodeKnowledgeGraph {
    ...
    async setupGitIntegration() {
        try {
            this.gitTracker = new git_change_tracker_js_1.GitChangeTracker({
...
exports.IncrementalKnowledgeGraph = IncrementalKnowledgeGraph;

...
class ArchitecturalAnalyzer {
    ...
    async analyzeArchitecture(files, context) {
        try {
            logger_js_1.logger.info('Starting architectural analysis', { fileCount: files.length });
            ...
            logger_js_1.logger.info('Architectural analysis completed', {
            ...
            logger_js_1.logger.error('Architectural analysis failed:', error);
            throw error;
        }
    }
    /**

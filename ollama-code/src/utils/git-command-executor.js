...
exports.GitCommandExecutor = void 0;
...
class GitCommandExecutor {
    ...
    static async execute(command, args = [], options) {
        try {
            ...
            logger_js_1.logger.debug('Executing git command', { command: fullCommand, cwd: sanitizedCwd });
            ...
            logger_js_1.logger.error('Git command execution failed', {
                command,
                args,
                cwd: options.cwd,
                error: error.message
...
GitCommandExecutor.ALLOWED_GIT_COMMANDS = [
    'status',
    'log',
    'diff',
    'show',

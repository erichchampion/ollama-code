...
const types_js_1 = require("../errors/types.js");
/**
 * Log levels
 */
var LogLevel;
...
class Logger {
    ...
    errorLevelToLogLevel(level) {
        switch (level) {
            case types_js_1.ErrorLevel.DEBUG:
                return LogLevel.DEBUG;
            case types_js_1.ErrorLevel.INFO:
                return LogLevel.INFO;
            case types_js_1.ErrorLevel.WARNING:
                return LogLevel.WARN;
            case types_js_1.ErrorLevel.ERROR:
            case types_js_1.ErrorLevel.CRITICAL:
            case types_js_1.ErrorLevel.FATAL:
...
if (process.env.NODE_ENV === 'development' || process.env.DEBUG === 'true') {
    ...
    exports.logger.configure({ verbose: true });
}

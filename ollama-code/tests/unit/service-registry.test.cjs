...
describe('ServiceRegistry', () => {
  ...
  beforeEach(async () => {
    ...
    try {
      ...
      const serviceRegistryModule = await import('../../src/interactive/service-registry.js');
  ...
  describe('Error Handling', () => {
    test('should handle factory errors gracefully', async () => {
      ...
      await expect(registry.getService('failing-service', factory)).rejects.toThrow('Factory failed');
      expect(factory).toHaveBeenCalledTimes(1);
    });

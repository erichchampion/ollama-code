...
describe('StreamingToolOrchestrator', () => {
  ...
  beforeEach(async () => {
    ...
    const orchestratorModule = await import('../../../src/tools/streaming-orchestrator.js');
    const adapterModule = await import('../../../src/tools/ollama-adapter.js');
...
describe('OllamaToolAdapter', () => {
  ...
  beforeEach(async () => {
    const adapterModule = await import('../../../src/tools/ollama-adapter.js');
    const registryModule = await import('../../../src/tools/registry.js');
    const filesystemModule = await import('../../../src/tools/filesystem.js');

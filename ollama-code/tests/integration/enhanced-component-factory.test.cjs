...
jest.doMock('/Users/erich/git/github/erichchampion/ollama-code/ollama-code/src/utils/logger.js', () => ({
  logger: mockLogger
}), { virtual: true });
...
describe('Enhanced Component Factory Integration Tests', () => {
  ...
  beforeEach(async () => {
    ...
    try {
      // Dynamic import for ES modules - use absolute paths for integration tests
      const factoryModulePath = '/Users/erich/git/github/erichchampion/ollama-code/ollama-code/src/interactive/enhanced-component-factory.js';
      const stateMachineModulePath = '/Users/erich/git/github/erichchampion/ollama-code/ollama-code/src/interactive/initialization-state-machine.js';
  ...
  describe('Component Initialization Flow', () => {
    ...
    test('should handle complex dependency chains', async () => {
      ...
      // naturalLanguageRouter depends on intentAnalyzer and taskPlanner

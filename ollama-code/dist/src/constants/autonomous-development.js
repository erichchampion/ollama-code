 ...
 */
export function getTestCoverageThreshold(level) {
    switch (level) {
 ...
 */
export function calculateEstimatedHours(requirementsCount, complexity, includeIntegration = true, includeTesting = true) {
...
export function getRiskLevel(probability) {
    if (probability < AUTONOMOUS_DEVELOPMENT_DEFAULTS.RISK_ASSESSMENT.LOW_THRESHOLD)
        return 'low';
    if (probability < AUTONOMOUS_DEVELOPMENT_DEFAULTS.RISK_ASSESSMENT.MEDIUM_THRESHOLD)
        return 'medium';
    return 'high';
}
/**
 ...
 */
export function calculateResourceRequirements(taskCount) {
    return {
...
//# sourceMappingURL=autonomous-development.js.map
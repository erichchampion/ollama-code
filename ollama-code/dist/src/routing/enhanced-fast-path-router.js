...
export class EnhancedFastPathRouter {
    ...
    isKnowledgeGraphQuery(input) {
        ...
        const hasKnowledgeGraphKeywords = knowledgeGraphKeywords.some(keyword => input.includes(keyword));
        // Check for pattern matches
        const hasKnowledgeGraphPatterns = knowledgeGraphPatterns.some(pattern => pattern.test(input));

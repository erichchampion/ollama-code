...
export class NaturalLanguageRouter {
    ...
    cacheManager = null;
    fileOperationClassifier; // Phase 2.2: File operation classification
     ...
     */
    createSimpleIntent(input, commandName, confidence = 1.0) {
        return {
            type: 'command',
            action: input,
            entities: {
...
If no command matches, respond with:
{
  ...
  "confidence": 0.0
     ...
     */
    estimateFileOperationTime(fileOperation) {
        const baseTime = {
            'create': 5,
            'edit': 10,
            'delete': 2,

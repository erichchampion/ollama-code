...
export class CodeEditor {
     ...
     */
    async createEdit(filePath, newContent, description) {
        const editId = uuidv4();
        try {
     ...
     */
    async validateJavaScript(content, errors, warnings) {
        try {
     ...
     */
    async validateTypeScript(content, errors, warnings) {
     ...
     */
    async validateJSON(content, errors, warnings) {
        try {
            JSON.parse(content);
        }
        catch (error) {
     ...
     */
    async validateMarkdown(content, errors, warnings) {
     ...
     */
    async validateGeneric(content, errors, warnings) {

...
export class OllamaProvider extends BaseAIProvider {
     ...
     */
    getModelQualityScore(modelName) {
        // Simplified scoring system (0-100)
        if (modelName.includes('llama3.1') || modelName.includes('qwen2.5-coder'))
            return 90;
        if (modelName.includes('llama3.2') || modelName.includes('qwen2.5'))
            return 85;
        if (modelName.includes('codellama:13b') || modelName.includes('codellama:34b'))
            return 80;
        if (modelName.includes('gemma:7b'))
            return 75;
        if (modelName.includes('codellama:7b'))
            return 70;

...
export class PerformanceAnalyzer {
    ...
    async analyzeProject(projectPath, options = {}) {
        ...
        const { includePatterns = ['**/*.js', '**/*.ts', '**/*.jsx', '**/*.tsx', '**/*.vue', '**/*.py', '**/*.java'], excludePatterns = getDefaultExcludePatterns(), respectGitIgnore = true, analyzeComplexity = true, analyzeBundleSize = true, checkMemoryLeaks = true, severityThreshold = 'info', maxFileSize = 2 * 1024 * 1024, // 2MB

 ...
 */
export function createDefaultVCSConfig(repositoryPath, overrides) {
    return {
        repositoryPath,
 ...
 */
export function safeParseEnum(value, allowedValues, fallback) {
...
//# sourceMappingURL=default-configurations.js.map
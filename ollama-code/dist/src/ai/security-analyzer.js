...
export class SecurityAnalyzer {
    ...
    async analyzeProject(projectPath, options = {}) {
        ...
        const { includePatterns = ['**/*.js', '**/*.ts', '**/*.jsx', '**/*.tsx', '**/*.py', '**/*.java', '**/*.php', '**/*.rb'], excludePatterns = getDefaultExcludePatterns(), respectGitIgnore = true, checkDependencies = true, enableCustomRules = true, severityThreshold = 'info', maxFileSize = 1024 * 1024, // 1MB

...
export class QueryPerformanceMonitor {
     ...
     */
    getPerformanceStats(timeWindow = '24h') {
    ...
    getMetricsInTimeWindow(timeWindow, offsetMs = 0) {
        const windowMs = {
            '1h': 60 * 60 * 1000,
            '24h': 24 * 60 * 60 * 1000,
            '7d': 7 * 24 * 60 * 60 * 1000,
    ...
    getTimeWindowOffset(timeWindow) {
        const windowMs = {
            '1h': 60 * 60 * 1000,
            '24h': 24 * 60 * 60 * 1000,
            '7d': 7 * 24 * 60 * 60 * 1000,
    ...
    calculateTrends(current, previous, timeWindow) {
        const trends = [];
...
//# sourceMappingURL=query-performance-monitor.js.map
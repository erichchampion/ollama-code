...
import { initializeFileOperationContext, executeFileOperation, createFileWithContent, modifyFileWithContent, generateCodeWithAI, generateTestFilePath, validateAndPreparePath } from '../utils/file-operation-helpers.js';
/**
 * Create file command
 */
 ...
 */
export const generateCodeCommand = {
    name: 'generate-code',
 ...
 */
export const createTestsCommand = {
    name: 'create-tests',
 ...
 */
export function getFileOperationCommands() {
    return [
        createFileCommand,
        editFileCommand,
        generateCodeCommand,

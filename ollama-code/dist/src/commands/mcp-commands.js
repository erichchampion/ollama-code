 ...
 * Start MCP server
 */
function registerMCPStartCommand() {
    const command = {
        name: 'mcp-start',
 ...
 * Stop MCP server
 */
function registerMCPStopCommand() {
    const command = {
        name: 'mcp-stop',
 ...
 */
function registerMCPStatusCommand() {
    const command = {
        name: 'mcp-status',
 ...
 */
function registerMCPToolsCommand() {
    const command = {
        name: 'mcp-tools',
                ...
                for (const tool of tools.tools) {
                    ...
                    if (tool.inputSchema.properties) {
                        ...
                        for (const [param, schema] of Object.entries(tool.inputSchema.properties)) {
                            ...
                            console.log(`     • ${param}: ${schema.type}${required}${description}`);
                        }
                    }
                    console.log('');
                }
 ...
 */
function registerMCPResourcesCommand() {
    const command = {
        name: 'mcp-resources',
 ...
 * Call an MCP tool
 */
function registerMCPCallCommand() {
    const command = {
        name: 'mcp-call',

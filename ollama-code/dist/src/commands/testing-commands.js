...
import { testManager } from '../testing/index.js';
 ...
 */
function registerTestSetupCommand() {
    const command = {
        name: 'test-setup',
 ...
 */
function registerTestGenerateCommand() {
    const command = {
        name: 'test-generate',
 ...
 */
function registerTestRunCommand() {
    const command = {
        name: 'test-run',
 ...
 */
function registerTestCoverageCommand() {
    const command = {
        name: 'test-coverage',
 ...
 */
function registerTestAnalyzeCommand() {
    const command = {
        name: 'test-analyze',

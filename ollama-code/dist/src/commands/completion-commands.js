...
import { shellCompletion } from '../shell/completion.js';
 ...
 */
function registerCompletionInstallCommand() {
    const command = {
        ...
        async handler(args) {
            try {
                ...
                const installPath = await shellCompletion.installCompletion(targetShell);
 ...
 */
function registerCompletionGenerateCommand() {
    const command = {
        name: 'completion',
 ...
 */
function registerCompletionCompleteCommand() {
    const command = {
        name: '__complete',
...
//# sourceMappingURL=completion-commands.js.map
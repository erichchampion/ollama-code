 ...
 */
function registerRefactorAnalyzeCommand() {
    const command = {
 ...
 */
function registerRefactorExtractCommand() {
    const command = {
 ...
 */
function registerRefactorRenameCommand() {
    const command = {
        ...
        async handler(args) {
            try {
                ...
                if (files) {
                    ...
                    filePaths = files.split(',').map((f) => f.trim());
                }
                else {
 ...
 */
function registerRefactorOptimizeCommand() {
    const command = {
 ...
 */
function registerRefactorSmellsCommand() {
    const command = {
 ...
 */
function registerRefactorPatternCommand() {
    const command = {
...
//# sourceMappingURL=refactoring-commands.js.map
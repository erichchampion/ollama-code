...
Return the complete refactored file content.`;
     ...
     */
    async extractVariable(filePath, line, expression, variableName) {
...
Return the complete refactored file content.`;
     ...
     */
    async renameSymbol(symbol, newName, filePaths) {
...
Return the optimized code.`;
     ...
     */
    async applyDesignPattern(filePath, pattern, options = {}) {
...
Return the refactored code with the design pattern applied.`;
     ...
     */
    async patternBasedAnalysis(code, filePath) {
        const operations = [];
     ...
     */
    calculateConditionalComplexity(line) {
     ...
     */
    async aiBasedSmellDetection(code, filePath) {
        try {
            const aiClient = await getEnhancedClient();

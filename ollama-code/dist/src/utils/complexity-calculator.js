 ...
 */
export function calculateCyclomaticComplexity(content, config) {
...
function categorizeComplexity(complexity, thresholds = { low: 5, moderate: 10, high: 20 }) {
...
function getComplexityDescription(complexity) {
    ...
    if (complexity <= 10)
        return 'More complex, but still manageable';
    if (complexity <= 20)
 ...
 */
export function calculateAverageComplexity(files, config) {

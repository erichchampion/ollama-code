...
export class UserIntentFactory {
     ...
     */
    static create(type, action, overrides = {}) {
        const defaultIntent = {
            type,
            action,
            entities: {
     ...
     */
    static createTaskExecution(action, overrides = {}) {
     ...
     */
    static createCommandIntent(action, confidence = 0.9, overrides = {}) {
     ...
     */
    static createTaskRequest(action, complexity = 'moderate', overrides = {}) {
     ...
     */
    static createQuestion(action, confidence = 0.7, overrides = {}) {
     ...
     */
    static createClarification(suggestions, overrides = {}) {
     ...
     */
    static createConversation(action = 'general_chat', overrides = {}) {
     ...
     */
    static mergeIntents(primary, secondary) {
        ...
        merged.estimatedDuration += secondary.reduce((sum, intent) => sum + intent.estimatedDuration, 0);
        return merged;
    }
    /**
...
//# sourceMappingURL=user-intent-factory.js.map
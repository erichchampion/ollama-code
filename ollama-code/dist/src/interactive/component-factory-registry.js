...
export class ComponentFactoryRegistry {
     ...
     */
    static createDependencyError(component, deps) {
        return InteractiveErrorHandler.createDependencyError(deps.join(' and '), { component: 'ComponentFactoryRegistry', operation: `create-${component}` });
    }
    /**
     * Register all component factory functions
     */
    static registerFactories() {
     ...
     */
    static async createComponent(type, dependencies = {}) {
     ...
     */
    static getComponentDependencies(type) {
        const dependencyMap = {
            aiClient: [],
            enhancedClient: [],
     ...
     */
    static validateDependencies(type, dependencies) {
 ...
 */
export async function createComponent(type, dependencies = {}) {
    return ComponentFactoryRegistry.createComponent(type, dependencies);
}
/**
 * Resolve dependencies automatically for a component
 */
export async function createComponentWithAutoResolve(type, baseDirectory) {
    const dependencies = {};
    if (baseDirectory) {
...
//# sourceMappingURL=component-factory-registry.js.map